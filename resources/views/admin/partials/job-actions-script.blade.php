...
<style>
    ...
    #jobs-reorder-toast { transition: opacity .25s ease, transform .25s ease; }
</style>
...
(function () {
    ...
    function showReorderToast(msg, isError) {
        ...
        toastTimer = setTimeout(() => { el.style.opacity = '0'; el.style.transform = 'translateY(.5rem)'; }, 2200);
    }
    ...
    function onSortableReady() {
        ...
        if (!container) return;
        new MutationObserver(initSortable).observe(container, { childList: true });
    }
