            ...
            $.get(mapConfig.jobsUrl, params || {}, function (response) {
                ...
                window.crmEnsureGoogleMarkerLibrary().then(function (lib) {
                    jobs.forEach(function (job) {
                        ...
                        var content = createSvgMarkerContent(job.equipment_color || '#64748b');
